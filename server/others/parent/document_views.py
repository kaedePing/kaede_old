...
class ListView(GenericAPIView):
    ...
    def post(self, request):
        ...
        serializer.create_downloadLink(serializer.data['id'])  # 调用更新该篇文档的下载地址
        return Response(serializer.data)
...
class DetailView(GenericAPIView):
    ...
    def delete(self, request, pk):
        ...
        """
        data = self.get_object()  # 获取查询的单个id数据
        os.remove(os.getcwd() + '/others/document/' + str(data.file))  # 删除源文件
