...
const config = {
  birthdate: 'June 05, 2023',
  name: '孙思佳',
  str:'首先祝你生日快乐,我亲爱的儿子.',
  str1:'当然，这首歌送给你,你可以等待这首完毕后进入下一个我给你的惊喜'
};
...
let countDown = new Date(`${config.birthdate} 19:00:00`).getTime();
x = setInterval(function() {
  ...
  let w = (c.width = window.innerWidth),
    ...
    hh = h / 2,
    opts = {
      strings: ['HAPPY', 'BIRTHDAY!', config.name,config.str,config.str1],
      charSize: 30,
      charSpacing: 35,
      lineHeight: 40,
  ...
  if (distance > 0) {
    ...
    function init() {
      ...
      box.addEventListener('click',playMusic,false);
      box.addEventListener('click',nextHtml,false);
    }
    ...
    function nextHtml() {
      var music = document.getElementById("song");
      var tTime = music.duration;
      console.log(tTime);
      setTimeout(function(){location.href="./login.html";},tTime*1000);
    }
